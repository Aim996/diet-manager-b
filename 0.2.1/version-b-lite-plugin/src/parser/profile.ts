...
const SEX_MAP: Readonly<Record<string, "male" | "female">> = {
  男: "male",
  女: "female",
};

const STATE_MAP: Readonly<Record<string, "cut" | "maintain" | "bulk">> = {
  减脂: "cut",
  增肌: "bulk",
  维持: "maintain",
};
...
function parseAge(source: string): number | null {
...
export function parseProfileCommand(
  ...
  const command: CoreProfileCommandCandidate = {
    action: "set_profile",
