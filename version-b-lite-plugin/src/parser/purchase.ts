...
function emptyPackage(): Readonly<CorePurchasePackageQuantity> {
...
function item(input: Readonly<{
  order: number;
  raw_name: string;
  normalized_name: CorePurchaseItemCandidate["normalized_name"];
  product_type: CorePurchaseItemCandidate["product_type"];
  identity_reference?: CorePurchaseItemCandidate["identity_reference"];
  specification?: CorePurchaseItemCandidate["specification"];
  package_quantity?: Readonly<CorePurchasePackageQuantity>;
  opening?: CorePurchaseItemCandidate["opening"];
  expiration?: CorePurchaseItemCandidate["expiration"];
}>): Readonly<CorePurchaseItemCandidate> {
  return Object.freeze({
    order: input.order,
...
function purchase(
  ...
  items: readonly Readonly<CorePurchaseItemCandidate>[],
