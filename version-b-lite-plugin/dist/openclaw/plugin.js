...
function clonePluginRoot(value) {
...
function acquirePluginRuntime(root, context) {
...
export default defineToolPlugin({
    ...
    tools: (tool) => [
        tool({
            name: "diet_manager",
            description: "Record completed current-user meals or plain water, or return a truthful non-writing outcome.",
