...
function payloadForIdentity(value) {
    if (typeof value !== "object" || value === null || Array.isArray(value))
        return invalid("payload");
    return Object.freeze(JSON.parse(canonicalJson(value)));
}
export function createInventoryAdjustmentFactIdentity(input) {
...
export function inventoryAdjustmentFactIdentityEquals(left, right) {
...
export function parseInventoryAdjustmentFactPreviewMaterial(value) {
    if (typeof value !== "object" || value === null || Array.isArray(value))
