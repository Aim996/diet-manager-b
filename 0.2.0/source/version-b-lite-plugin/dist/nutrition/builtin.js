...
const COMMON_FOODS = freezeNutritionData({
    milk: {
...
const COMMON_DISHES = freezeNutritionData({
    fried_rice: {
...
function resolveBuiltin(request) {
    ...
    const evidence = freezeNutritionData({
        source_id: "local.generic_estimate",
 ...
 */
export function resolveBuiltinNutrientVector(normalizedName, amountMicrounits) {
...
export function createCommonDishTemplateAdapters() {
    return Object.freeze([
...
export function createBuiltinNutritionAdapters() {
    return Object.freeze([
